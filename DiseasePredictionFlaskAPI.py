...
client = MongoClient("mongodb+srv://DSHarman:<db_password>@harmandiseaseprediction.wbo3b.mongodb.net/?retryWrites=true&w=majority&appName=harmandiseaseprediction")
